...
conv_1 = Conv2D(32, (3, 3), activation='relu', padding='same',kernel_initializer='normal')(input_img)
...
conv_2 = Conv2D(64, (3, 3), activation='relu', padding='same',kernel_initializer='normal')(maxpool_1)
...
conv_3 = Conv2D(128, (3, 3), activation='relu', padding='same',kernel_initializer='normal')(maxpool_2)
...
h_5 = Dense(128*8*8,activation='relu')(h_4)
h_6 = Reshape((8,8,128))(h_5)
...
conv_7 = Conv2D(128, (3, 3), activation='relu', padding='same',kernel_initializer='normal')(h_6)
#upsample_7 = UpSampling2D((2, 2))(conv_7)

conv_7 = concatenate([conv_7,conv_4])
conv_8 = Conv2D(128, (3, 3), activation='relu', padding='same',kernel_initializer='normal')(conv_7)
upsample_8 = UpSampling2D((2, 2))(conv_8)

upsample_8 = concatenate([upsample_8,conv_3])
conv_9 = Conv2D(64, (3, 3), activation='relu', padding='same',kernel_initializer='normal')(upsample_8)
upsample_9 = UpSampling2D((2, 2))(conv_9)

upsample_9 = concatenate([upsample_9,conv_2])
conv_10 = Conv2D(32,  (3, 3), activation='tanh',padding='same',kernel_initializer='normal')(upsample_9)
...
vae.fit(train_Img[:10000], train_Img[:10000], shuffle=True, epochs=50, batch_size=batch_size, validation_data=(train_Img[10000:11000],train_Img[10000:11000]),callbacks=[EarlyStopping])
